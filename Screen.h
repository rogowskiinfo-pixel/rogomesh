...
// ==========================================
// ROGOMESH: Definicao dos Estados da Tela
// ==========================================
enum RogoScreenState {
    ROGO_SCREEN_SYSTEM,
    ROGO_SCREEN_NETWORK,
    ROGO_SCREEN_GPS,
    ROGO_SCREEN_ENERGY,
    ROGO_SCREEN_RADIO,
    ROGO_SCREEN_DIAGNOSTIC
};

// Variavel global para guardar a tela atual
extern RogoScreenState currentRogoState;
// ==========================================
...
class Screen
{
  public:
    ...
    // ROGOMESH: Função principal de renderização
   // void drawRogoMeshScreen(OLEDDisplay *display, OLEDDisplayUiState *state, int16_t x, int16_t y);
    void onPress() {}
    void setup() {}
    void setOn(bool) {}
...
class Screen : public concurrency::OSThread
{
  ...
  public:
    ...
    // ROGOMESH: Função principal de renderização
    static void drawRogoMeshScreen(OLEDDisplay *display, OLEDDisplayUiState *state, int16_t x, int16_t y);
    ~Screen();
